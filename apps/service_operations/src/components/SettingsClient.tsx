    ...
    <section className="panel">
      ...
      <div className="formGrid two commSettingsGrid">
        <div className="commSettingsCard">
          ...
          <div className="field"><label>Gemini Model</label><select value={settings.formVisionModel} onChange={e=>setSettings({...settings,formVisionModel:e.target.value})}><option value="gemini-2.5-flash">Gemini 2.5 Flash · recommended</option><option value="gemini-2.5-flash-lite">Gemini 2.5 Flash-Lite · fastest / lower cost</option></select></div>
