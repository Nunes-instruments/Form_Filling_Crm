  ...
  return <div className="stack24">
    ...
    <section className="panel reportControlPanel">
      ...
      <div className="reportFilters">
        <div className="searchBox"><Search size={18}/><input value={query} onChange={e=>setQuery(e.target.value)} placeholder="Search job, company, phone, product, model, serial noâ€¦"/></div>
